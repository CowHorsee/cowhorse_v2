  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
      <section className="grid gap-5 xl:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.8fr)]">
        <div className="overflow-hidden rounded-[32px] bg-brand-blue p-6 text-white shadow-[0_28px_80px_rgba(15,23,42,0.34)] md:p-8">
          ...
          <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-200 md:text-base">
                ...
                request volume, spend exposure, and inventory demand trends.
              </p>
            </div>
            <div className="min-w-[220px] rounded-[24px] border border-white/10 bg-white/10 p-4">
